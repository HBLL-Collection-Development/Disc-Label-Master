...
if (useExcel)
	...
	{
		ifWinNotExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
			ifWinNotExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
			{
				myBubble("BiblioScript Excel Spreadsheet","Opening Excel Spreadsheet...")
				run BiblioScriptDVDProject.xlsx
				WinWait , Microsoft Excel - BiblioScriptDVDProject.xlsx
...
loop
{
	if (!inProcess)
	{
		IfWinExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
		{	
			WinGet , isMin , MinMax, Microsoft Excel - BiblioScriptDVDProject.xlsx
			if (isMin != -1)
				winMaximize , Microsoft Excel - BiblioScriptDVDProject.xlsx
		}	
...
printSequence:
	if (useExcel)
	{
		...
		ifWinExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
			WinWaitNotActive ,  Microsoft Excel - BiblioScriptDVDProject.xlsx
		else
			WinWaitNotActive ,  Microsoft Excel - BiblioScriptDVDProject.xlsx
		myBubbleOff()
	}
...
{
	ifWinExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
		WinMinimize , Microsoft Excel - BiblioScriptDVDProject.xlsx
	else
		WinMinimize , Microsoft Excel - BiblioScriptDVDProject.xlsx
	WinWaitNotActive , Microsoft Excel - BiblioScriptDVDProject.xlsx
}
...
{
	ifWinExist , Microsoft Excel - BiblioScriptDVDProject.xlsx
		WinActivate , Microsoft Excel - BiblioScriptDVDProject.xlsx
	else
		WinActivate , Microsoft Excel - BiblioScriptDVDProject.xlsx
	WinWaitActive , Microsoft Excel - BiblioScriptDVDProject.xlsx
	WinMaximize , Microsoft Excel - BiblioScriptDVDProject.xlsx
}
minLabeler()
{
